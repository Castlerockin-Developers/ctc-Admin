...
const AddStudents = ({
  ...
  useEffect(() => {
    if (isEditing && editExamData) {
      ...
      if (studentsData && studentsData.length > 0) {
        const studentsFromExam = studentsData
          .map((student) => {
  ...
  const filteredAll = allStudents.filter(
    (s) =>
          ...
          <div className="all-student-added">
            ...
            <div className="all-s-body">
              ...
              <div className="pagination flex justify-center items-center gap-2 mt-2">
                ...
                <span>
                  {filteredAdded.length ? addedPage : 0} /{" "}
                  {Math.ceil(filteredAdded.length / studentsPerPage) || 0}
                </span>
                <button
                  disabled={
