...
const ManageExam = () => {
    ...
    // Handle hover to dynamically position sub-popup
    ...
    // Keep sub-menu open and maintain active background for main item
    ...
    // Cancel closing when hovering over the sub-popup
    ...
    const tableData = [
        ...
        { id: 2, category: "Completed", name: "Phyton", startTime: "12:00 PM", endTime: "1:30 PM", analytics: "90%", status: "Ongoing" },
        { id: 3, category: "Completed", name: "JAVA", startTime: "2:00 PM", endTime: "3:00 PM", analytics: "76%", status: "Upcoming" },
        { id: 4, category: "Completed", name: "JavaScipt", startTime: "3:30 PM", endTime: "5:00 PM", analytics: "88%", status: "Completed" },
        { id: 5, category: "Active", name: "React Js", startTime: "5:30 PM", endTime: "7:00 PM", analytics: "92%", status: "Ongoing" }
    ];

    // Function to filter table data based on activeButton state
