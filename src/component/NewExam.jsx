...
const InfoTip = ({ text }) => (
  <span className="tooltip-container" role="note" tabIndex={0}>
    <FaInfoCircle className="info-badge" aria-hidden="true" />
...
const NewExam = ({
  ...
  const handleNext = () => {
    ...
    if (formIsValid) {
      ...
      const allErrorMessages = Object.values(errors).filter(
        (msg) => msg !== ""
      ); //
      ...
      if (uniqueErrorMessages.length > 0) {
        //
        showErrorSummaryAlert(
          "Validation Errors",
          uniqueErrorMessages.join("<br/>")
        ); //
      } else {
      ...
      <div className="newexam-box">
        ...
        <div className="newexam-entry1">
          ...
          <div className="createexam-col1 flex">
            <h4 className="flex justify-between">
              Exam Start Date{" "}
              {isSubmitted && errors.examStartDate && (
                <span style={{ color: "red" }}>*</span>
              )}
            </h4>
            <input
          ...
          <div className="createexam-col1 flex">
            <h4 className="flex justify-between">
              Exam End Date{" "}
              {isSubmitted && errors.examEndDate && (
                <span style={{ color: "red" }}>*</span>
              )}
            </h4>
            <input
          ...
          <div className="createexam-col1 flex">
            ...
            <h4 className="flex items-center gap-2">
              Timed Test
              <InfoTip text="If the toggle is checked, the timer will be applied to the whole assessment. If not checked, the exam will be section timed." />
              {isSubmitted && errors.timedTest && (
                <span style={{ color: "red" }}>*</span>
              )}
            </h4>
            ...
            <div>
              <label className="toggle-switch">
                <input
                  ...
                  checked={timedTest}
                  onChange={(e) => {
                    setTimedTest(e.target.checked); //overall timed
                    if (!e.target.checked) {
